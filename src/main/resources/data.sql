INSERT IGNORE INTO category (id, name) VALUES (1, 'shoes');
INSERT IGNORE INTO category (id, name) VALUES (2, 'books');
INSERT IGNORE INTO category (id, name) VALUES (3, 'electronics');

INSERT IGNORE INTO product (id, name, description, stock,price,status, create_at,category_id)
